    ...
    <div className={styles.container}>
      {
        <>
            ...
            <div className={styles.callButton}>
              <Image style={{cursor:"pointer"}} href='/' src="/images/telephone.png" alt="" width={32} height={32}  />
            </div>
          ...
          <div className={styles.itemMobileOnly}>
            <Link className={styles.adminHeadLine} href='/admin'>
            <h2 >Admin Dashboard   <RiAdminLine /></h2>
